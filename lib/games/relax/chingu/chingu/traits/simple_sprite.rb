  ...
  module Traits
    ...
    module SimpleSprite
      ...
      def setup_trait(object_options = {})
        ...
        self.factor = options[:factor] || options[:scale] || $chingu_window.factor || 1.0
      ...
      # Examples:
      #   image = 'rocket.png'
      #   image = Gosu::Image.new($chingu_window, 'rocket.png')
      #
      #    image = lambda do
      #      # TexPlay is library for Gosu image generation
      #      TexPlay.create_image($chingu_window,10,10).paint { circle(5,5,5, :color => :red) }
      #    end
      #
      def image=(image)
        ...
        @image = if String === image
                   ...
                   Gosu::Image.new($chingu_window, image,false) rescue Gosu::Image[image]
