...
module Chingu
  ...
  class BasicGameObject
    ...
    def initialize(options = {})
      ...
      #
      # A GameObject either belong to a GameState or our mainwindow ($chingu_window)
      #
      @parent = $chingu_window.current_scope if !@parent && $chingu_window
    ...
    # Otherwise it will be added to $chingu_window.game_objects list.
    ...
    def self.all
      ...
      #  $chingu_window.current_scope.game_objects.of_class(self).dup  # old school way
    end
