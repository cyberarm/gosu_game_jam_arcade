...
module Chingu
  ...
  class Parallax < Chingu::GameObject
    ...
    #
    # TODO: make use of $chingu_window.milliseconds_since_last_update here!
    #
    def update
    ...
    def draw
      @layers.each do |layer|
        ...
        while layer.repeat_x && layer.x < $chingu_window.width
          while layer.repeat_y && layer.y < $chingu_window.height
            layer.draw
