  ...
  module GameStates
    ...
    class Debug < Chingu::GameState
      ...
      def initialize(options = {})
        ...
        # it fails when setup in DEFAULTS as it needs existing $chingu_window
        @font ||= Gosu::Font[16]
      ...
      def draw
        ...
        $chingu_window.draw_quad(  0,0,@fade_color,
                            $chingu_window.width,0,@fade_color,
                            $chingu_window.width,$chingu_window.height,@fade_color,
                            0,$chingu_window.height,@fade_color,10)
