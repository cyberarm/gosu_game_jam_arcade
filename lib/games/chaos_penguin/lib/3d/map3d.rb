    ...
    module L3D
        class Map3D
            ...
            def initialize(map_path, tileset_path, tile_size)
                ...
                # Ground
                @ground = Omega::L3D::Texture3D.new("#{ChaosPenguinGame::GAME_ROOT_PATH}/assets/pavedground.png")
                ...
                # Some objects
                @house = Omega::L3D::Cube.new("#{ChaosPenguinGame::GAME_ROOT_PATH}/assets/house.png")
                ...
                @building = Omega::L3D::Cube.new("#{ChaosPenguinGame::GAME_ROOT_PATH}/assets/building.jpg")
