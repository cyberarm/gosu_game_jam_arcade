...
class ButterflySurferGame
  ...
  class ButterflySurfer < Gosu::Window
    ...
    def initialize
      ...
      @game_music = Gosu::Song.new("#{ButterflySurferGame::GAME_ROOT_PATH}/sounds/through space.ogg")
      @main_menu_music = Gosu::Song.new("#{ButterflySurferGame::GAME_ROOT_PATH}/sounds/space.flac")
      @death_sound = Gosu::Sample.new("#{ButterflySurferGame::GAME_ROOT_PATH}/sounds/atari_boom3.wav")
      @beep_sound = Gosu::Sample.new("#{ButterflySurferGame::GAME_ROOT_PATH}/sounds/beep.wav")
